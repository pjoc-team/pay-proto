...
var (
	pattern_SettlementGateway_ProcessSuccess_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "settlement", "gateway_order_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SettlementGateway_ProcessOrderSuccess_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "settlement"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SettlementGateway_NotifyOrder_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "notify"}, "", runtime.AssumeColonVerbOpt(true)))
)
